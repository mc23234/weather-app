...
async function getCoordinates(city){
		try{
			error.innerHTML = '';
		const response = await fetch(`http://api.openweathermap.org/data/2.5/weather?q=${city}&appid=f3ff2d887ca8e44b4d677a9bfe02f400`)
...
async function weatherUpdate(lat,lon){
		const response = await fetch(`http://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&exclude=minutely&appid=f3ff2d887ca8e44b4d677a9bfe02f400`)
